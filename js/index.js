class Horario {
  ...
  function agregarHora(hora) {
    const { id, fecha, horaI, horaF,disponibilidad} = hora;
    const generatedHTML = generateHTMLToCreateCard(id, fecha, horaI, horaF,disponibilidad);
    horaDiv.innerHTML += generatedHTML;
  }
